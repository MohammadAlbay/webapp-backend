...
<body>
    <div class="page-header">
        <h3 class="page-title"> بلاغات الفنيين </h3>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div style="padding:0.5em;border:2px solid gray; border-radius:0.5em">
                    <button onclick="searchForTechnicainReports(search_input)" id="search_btn" class="btn btn-primary">بحث</button>
                ...
                <div id="nodata-view" style="text-align:center; display: block;">
                    ...
                    @include('employee.dashboard.technicain-reports-searchview')
                </div>
    ...
    <script>
        ...
        async function searchForTechnicainReports(input) {
            const dataViewDiv = document.querySelector('#data-view');
            const nodataViewDiv = document.querySelector('#nodata-view');

            const url = "/employee/technicain/reports/search";
        ...
        async function sendWarning(id) {
            const url = "/employee/technicain/reports/warn";
            ...
            if (result.State == 1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed)
                        ViewFetch.Load('manage-technicain-reports')
        ...
        async function blockCustomer(id) {
            const url = "/employee/technicain/reports/restrict";
        ...
        async function markDone(id) {
            const url = "/employee/technicain/reports/done";
            ...
            if (result.State == 1) {
                ...
                Swal.fire({
                    ...
                    showConfirmButton: true,
                    confirmButtonText: 'تم'
                }).then(async (result) => ViewFetch.Load('manage-technicain-reports'));
            }
